        ...
        <div class="container mt-5">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div class="card text-center bg-light" style="height: 100%;">
                <div class="card-body">
                  <img src="ako.jpg" class="w-50 rounded-circle" alt="">
                  <h5 class="card-title mt-3">Lalaine L. Delarmente</h5>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div class="card text-center bg-light" style="height: 100%;">
                <div class="card-body">
                  <img src="ako1.jpg" class="w-50 rounded-circle" alt="">
                  <h5 class="card-title mt-3">Lalaine L. Delarmente</h5>
                  <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas voluptatem repellendus unde veniam eius quia inventore amet dicta? Incidunt, cumque.</p>
                  <i class="fab fa-twitter"></i>&nbsp;
                  <i class="fab fa-facebook-f"></i>&nbsp;
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div class="card text-center bg-light" style="height: 100%;">
                <div class="card-body">
                  <img src="ako2.jpg" class="w-50 rounded-circle" alt="">
                  <h5 class="card-title mt-3">Lalaine L. Delarmente</h5>
                  <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas voluptatem repellendus unde veniam eius quia inventore amet dicta? Incidunt, cumque.</p>
                  <i class="fab fa-twitter"></i>&nbsp;
                  <i class="fab fa-facebook-f"></i>&nbsp;
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div class="card text-center bg-light" style="height: 100%;">
                <div class="card-body">
                  <img src="ako3.jpg" class="w-50 rounded-circle" alt="">
                  <h5 class="card-title mt-3">Lalaine L. Delarmente</h5>
                  <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas voluptatem repellendus unde veniam eius quia inventore amet dicta? Incidunt, cumque.</p>
                  <i class="fab fa-twitter"></i>&nbsp;
                  <i class="fab fa-facebook-f"></i>&nbsp;
...
<?php /**PATH C:\Users\lalai\DelarmenteL\resources\views/layout/html.blade.php ENDPATH**/ ?>